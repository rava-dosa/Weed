...
process_image::resize_new(Mat frame)
{
	Mat Resize(Mat frame)
	{
		...
		for(j=0; j<ocols; j++)
		{
		    outimage.at<Vec3b>((1/y_ratio)*i, (1/x_ratio)*j)[2] = frame.at<Vec3b>(i, j)[2];
		    outimage.at<Vec3b>((1/y_ratio)*i, (1/x_ratio)*j)[1] = frame.at<Vec3b>(i, j)[1];
		    outimage.at<Vec3b>((1/y_ratio)*i, (1/x_ratio)*j)[0] = frame.at<Vec3b>(i, j)[0];
